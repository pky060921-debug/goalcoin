 ...
 */
const makeBatcher = (request, params) => (() => {
    const queue = [];
    let debounce;
    const timeoutBatchCall = () => {
        ...
        debounce = setTimeout(() => {
            ...
            const { elements, resolvers, rejecters } = queue.reduce((acc, { element, resolve, reject }) => {
...
exports.makeBatcher = makeBatcher;
