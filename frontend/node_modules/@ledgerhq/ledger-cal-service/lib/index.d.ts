...
declare const _default: {
    findCurrencyData: typeof findCurrencyData;
    findToken: import("@ledgerhq/live-network/lib/cache").CacheRes<[filter: any, opt: any], import("./tokens").TokenData>;
    getCertificate: typeof getCertificate;
    getNetworks: import("@ledgerhq/live-network/lib/cache").CacheRes<[id: any, opt: any], {
        id: string;
        name: string;
        coin: string;
        chainId: number;
    ...
    getProvidersCDNData: typeof getProvidersCDNData;
    getProvidersData: typeof getProvidersData;
};
