...
export default function decodeBitString(value) {
    if (value.length === 0) {
    ...
    for (let i = 1; i < value.length; i++) {
        ret.push(((value[i] & 0b10000000) ? TRUE_BIT : FALSE_BIT), ((value[i] & 0b01000000) ? TRUE_BIT : FALSE_BIT), ((value[i] & 0b00100000) ? TRUE_BIT : FALSE_BIT), ((value[i] & 0b00010000) ? TRUE_BIT : FALSE_BIT), ((value[i] & 0b00001000) ? TRUE_BIT : FALSE_BIT), ((value[i] & 0b00000100) ? TRUE_BIT : FALSE_BIT), ((value[i] & 0b00000010) ? TRUE_BIT : FALSE_BIT), ((value[i] & 0b00000001) ? TRUE_BIT : FALSE_BIT));
    }
