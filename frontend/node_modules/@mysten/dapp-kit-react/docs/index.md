...
> **Note:** **Migrating from @mysten/dapp-kit?** If you're currently using the legacy
> `@mysten/dapp-kit` package, check out our [Migration Guide](/sui/migrations/sui-2.0/dapp-kit) to
> upgrade to the new packages with gRPC and GraphQL support.
...
> **Warning:** **Deprecated JSON RPC Only**: This legacy package only works with the deprecated JSON
> RPC API and will not be updated to support gRPC or GraphQL. All new projects should use
