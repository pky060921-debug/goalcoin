...
> **Note:** **shadcn/ui Compatibility**: The dApp Kit uses the same CSS custom property naming
> convention as shadcn/ui. If your application already uses shadcn/ui themes, the dApp Kit
> components will automatically inherit your theme. You can also use
> [shadcn/ui's theme builder](https://ui.shadcn.com/themes) to create custom themes.
