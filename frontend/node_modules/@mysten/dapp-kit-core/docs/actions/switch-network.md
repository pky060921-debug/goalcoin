...
> **Note:** Network switching only affects your dApp's client connection. The wallet itself is not
> affected by this change, and wallets are not notified when the network changes in the dApp.
